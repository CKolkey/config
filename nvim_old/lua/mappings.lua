...
M.mappings = {
  ...
  normal = {
    ...
    ["<c-s>"] = require("telescope.builtin").lsp_workspace_symbols,
    ["<c-space>"] = require("telescope.builtin").grep_string,
    ["<leader>ti"] = require("telescope.builtin").lsp_implementations,
    ["<leader>td"] = require("telescope.builtin").lsp_definitions,
    ["<leader>tr"] = require("telescope.builtin").lsp_references,
