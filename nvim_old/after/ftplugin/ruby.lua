...
-- vim.api.nvim_buf_create_user_command(0, "AC", [[:execute "e " . eval('rails#buffer().alternate()')]], {})
-- vim.api.nvim_buf_create_user_command(0, "ASC", [[:execute "split " . eval('rails#buffer().alternate()')]], {})
-- vim.api.nvim_buf_create_user_command(0, "AVC", [[:execute "vsplit " . eval('rails#buffer().alternate()')]], {})
