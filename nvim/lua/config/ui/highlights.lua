...
return {
  ...
  CursorLine                   = { bg = c.line_purple, style = c.none },
  ...
  SignColumn                   = { bg = c.bg0 },
  Folded                       = { bg = c.bg2 },
  StatusColumnBorder           = { fg = c.line_purple, bg = c.bg0 },
  ...
  GitSignsAdd                  = { fg = c.green, bg = c.bg0, style = c.none },
  GitSignsChange               = { fg = c.blue, bg = c.bg0, style = c.none },
  GitSignsDelete               = { fg = c.red, bg = c.bg0, style = c.none },
  GitSignsUntracked            = { fg = c.purple, bg = c.bg0, style = c.none },
