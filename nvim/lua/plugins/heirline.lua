  ...
  config = function()
    ...
    local LSP = {
      ...
      },
      {
        ...
        hl       = { fg = Colors.bg_blue, bold = true },
      },
    ...
    local left = {
      Mode("  "), Padding(2), FileSize, Padding(2), FileIcon, FilePath, FileFlags, Padding(2), Ruler,
      Padding(2), ScrollBar --, Padding(2), Diagnostics
    }
    ...
    local StatusLine = {
      Mode("▉ "), left, separator, center, separator, right, Mode(" ▉"),
      hl = {
        bg = Colors.bg0,
        fg = Colors.fg
      }
